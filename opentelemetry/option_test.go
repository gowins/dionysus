...
func TestWithTraceOptions(t *testing.T) {
	...
	opts := []Option{}
	opts = append(opts, WithTraceExporter(testTraceExporter), WithMetricExporter(testMetricExporter),
	...
	for _, batchOption := range testConfig.traceBatcOptions {
